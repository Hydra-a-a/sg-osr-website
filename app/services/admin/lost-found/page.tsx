...
export default function AdminLostFoundPage() {
    ...
    return (
        <AdminPageShell
            eyebrow="Officer moderation"
            title="Lost and found queue"
            description="Publish verified CSO bulletins, review student reports, and retire resolved listings."
            icon={ShieldCheck}
            actions={(
        ...
        >
                ...
                <div className="admin-lost-found-workspace mt-8 space-y-6">
                    ...
                    <AdminInspector mode="drawer" open={Boolean(selectedItem && mobileDetailOpen)} onClose={() => setMobileDetailOpen(false)} title={selectedItem?.title || 'Report inspector'} eyebrow="Record inspector" drawerSize="xl">
