...
export default function AdminClassroomPage() {
    return (
        <AdminPageShell
            eyebrow="Linked operation"
            title="Google Classroom"
            description="Protected course and coursework controls. Public transparency pages continue to render their own read-only presentation."
            icon={GraduationCap}
